...
void	COperatingSystem::Init(uint width, uint height)
{
	...
	* You may need to change this to 16 or 32 for your system */
	...
	window = SDL_CreateWindow("App", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, (int)width,
	                          (int)height, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
	if (window == nullptr)
	{
		return;
	}
...
void COperatingSystem::SetMousePos(Vec2 pos)
{
...
SDL_Window* COperatingSystem::GetWindow() const
{
	return window;
}
