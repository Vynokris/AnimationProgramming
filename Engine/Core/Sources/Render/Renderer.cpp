...
void	CRenderer::ComputeProjectionMatrix( float nearPlane, float farPlane, float w, float h, Matrix44& projMatrix )
{
	projMatrix.a11 = w;
	projMatrix.a12 = 0.0f;
	projMatrix.a13 = 0.0f;
	...
	projMatrix.a31 = 0.0f;
	projMatrix.a32 = 0.0f;
	projMatrix.a33 = (nearPlane + farPlane) / (nearPlane - farPlane);
	projMatrix.a34 = -1.0f;
	
	projMatrix.a41 = 0.0f;
	projMatrix.a42 = 0.0f;
	projMatrix.a43 = (2.0f * nearPlane * farPlane) / (nearPlane - farPlane);
	projMatrix.a44 = 0.0f;			
}
